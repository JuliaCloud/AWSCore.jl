...
[apis/cognito-sync-2014-06-30.normal.json](https://github.com/aws/aws-sdk-js/blob/master/apis/cognito-sync-2014-06-30.normal.json).
See [JuliaCloud/AWSCore.jl](https://github.com/JuliaCloud/AWSCore.jl).

```@index
Pages = ["AWSSDK.CognitoSync.md"]
```

```@autodocs
Modules = [AWSSDK.CognitoSync]
```
